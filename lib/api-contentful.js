...
export async function getHomeData() {
  ...
  const metaData = {
    metaTitle: layoutEntry.fields.metadataTitle,
    metaDesc: layoutEntry.fields.metadataDescription,
    metaImg: {
      metaImgWidth: layoutEntry.fields.metadataImage?.fields.file.details.image.width,
      metaImgHeight: layoutEntry.fields.metadataImage?.fields.file.details.image.height,
      metaImgContentType: layoutEntry.fields.metadataImage?.fields.file.contentType,
      metaImgUrl: layoutEntry.fields.metadataImage?.fields.file.url,
    },
  };
